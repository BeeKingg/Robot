...
PM_START_TEXT = """
 ───「[Skyla](https://t.me/SkylaMusicBot)」───
*Hello {} !*
────────────────────────
Skyla a powerful group management bot built to help you manage your group!
────────────────────
...
buttons = [
        ...
        InlineKeyboardButton(
            text="➕️ Add Skyla to your group ➕️", url="t.me/SkylaMusicBot?startgroup=true"
        ),
    ],
    [
        InlineKeyboardButton(text="Support", url="https://t.me/skylasupport"
        ),
        InlineKeyboardButton(
...
PRIME_IMG = "https://telegra.ph/file/5af32594e504236410892.jpg"
...
def prime_about_callback(update, context):
    ...
    if query.data == "prime_":
        query.message.edit_text(
            ...
            "\n\n Click on button bellow to get basic help for Skyla.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Skyla now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Skyla support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on PrimeMega.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/skylasupport"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/SkylaIND"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="prime_"),
        ...
        query.message.edit_text(
            ...
            f"\nHere Developers Making The SkylaMusicBot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="SkyNot", url="t.me/Zxyune"),
                    InlineKeyboardButton(text="SkylaIND", url="t.me/SkylaIND"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="prime_"),
